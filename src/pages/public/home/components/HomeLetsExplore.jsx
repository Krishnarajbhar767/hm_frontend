...
function HomeLetsExplore() {
    ...
    return (
        <div className=" py-4">
            ...
            <div className="relative h-[400px] md:h-[600px] py-4 bg-[url('./assets/images/Home/HomeLetsExplore/SF_1920x1080.jpg')] bg-fixed bg-center bg-cover bg-no-repeat text-white">
