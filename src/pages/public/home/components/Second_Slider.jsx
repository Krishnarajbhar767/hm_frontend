...
function Second_Slider({ textPosition = false, sliderData = [] }) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 flex items-end justify-center px-16 sm:px-20 md:px-24 lg:px-32 xl:px-40 py-8">
                <AnimatePresence mode="wait">
                    {sliderData[activeSlide] && (
                        ...
                        >
                            ...
                            <motion.h1
                                variants={textVariants}
                                className="hidden sm:block mt-5 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-4xl font-bold mb-3 sm:mb-4 md:mb-6 leading-tight drop-shadow-lg"
                            >
                                {sliderData[activeSlide].heading}
                            </motion.h1>
                            ...
                            <motion.p
                                ...
                                className={`hidden sm:block text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 md:mb-8 leading-relaxed text-white/95 drop-shadow-md ${textPosition
                                    ...
                                    : "max-w-md mx-auto lg:mx-0 lg:mr-auto"
                                    }`}
                            >
